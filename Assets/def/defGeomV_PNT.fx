...
PS_OUTPUT PS( VS_OUTPUT input ) : SV_Target
{
  ...
  noiseIn = input.PosO.xyz*float3(2.50000f, 2.50000f, 2.50000f) + float3(0.00000f, 0.00000f, 0.00000f);
;
...
;
  ...
  noiseIn = input.PosO.xyz*float3(2.00000f, 2.00000f, 2.00000f) + float3(0.44000f, 0.44000f, 0.44000f);
;
...
;
  ...
  noiseIn = input.PosO.xyz*float3(1.80000f, 1.80000f, 1.80000f);
  noiseT = 0;
  ...
  noiseIn = input.PosO.xyz*float3(2.40000f, 2.40000f, 2.40000f);
  noiseT = 0;
  ...
  noiseIn = input.PosO.xyz*float3(0.50000f, 0.50000f, 0.50000f);
  noiseT = 0;
  ...
  noiseIn = input.PosO.xyz*float3(0.60000f, 0.60000f, 0.60000f);
  value = Snoise3D ( noiseIn);
...
//FINAL PIXEL
  ...
  for ( int i = 0; i < 4 ; ++i)
    {
    float3 inputParameters = input.PosO + vec[i];
...
;
  ...
  noiseIn = inputParameters.xyz*float3(1.80000f, 1.80000f, 1.80000f);
  noiseT = 0;
  vectorValue = noiseIn * float3(1.20000f, 1.20000f, 1.20000f);
  value = abs( cos( vectorValue.x + vectorValue.y + vectorValue.z + 0.00000f + Snoise3D( 1.00000f *noiseIn )));
  if ( value < 0.30000f)
  ...
  noiseIn = inputParameters.xyz*float3(2.40000f, 2.40000f, 2.40000f);
  noiseT = 0;
  vectorValue = noiseIn * float3(4.80000f, 4.80000f, 4.80000f);
  value = abs( cos( vectorValue.x + vectorValue.y + vectorValue.z + 2.44800f + Snoise3D( 1.00000f *noiseIn )));
  if ( value < 0.20000f)
  ...
  noiseIn = inputParameters.xyz*float3(0.50000f, 0.50000f, 0.50000f);
  noiseT = 0;
  value = Snoise3D ( noiseIn);
  noiseT = abs( noiseIn.x + value );
  noiseT = clamp( noiseT, 0, 1 );
  ...
  noiseIn = inputParameters.xyz*float3(0.60000f, 0.60000f, 0.60000f);
  value = Snoise3D ( noiseIn);
noiseT =  sqrt(abs(cos( 3*noiseIn.x + 2*value ) ) );   noiseT = clamp( noiseT, 0, 1 );
  float4 Signal55 = lerp( float4(0.00000f, 0.00000f, 0.00000f, 1.00000f), float4(0.81569f, 0.60392f, 0.06275f, 1.00000f), noiseT );
