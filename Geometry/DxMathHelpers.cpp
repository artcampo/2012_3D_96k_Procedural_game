...
D3DXVECTOR3 unitVector( D3DXVECTOR3 aPointEnd, D3DXVECTOR3 aPointBegin )
{
  D3DXVECTOR3 u = aPointEnd - aPointBegin;
  D3DXVec3Normalize( &u, &u );
  return u;
}

D3DXVECTOR3 normalizeVector( const D3DXVECTOR3 aP1)
{
  D3DXVECTOR3 u = aP1;
  D3DXVec3Normalize( &u, &u );
  return u;
...
void        cleanZeroes ( D3DXVECTOR3& v )
{
                        ...
                        const D3DXVECTOR3& p3, const D3DXVECTOR3& p4 )
{
  ...
  *Global::mFileDebugColIt << "d " <<d << std::endl;
  //return equality( fabs(d), 0.0f, 0.001f );

  // TODO: COPLANARITY
  return equality( fabs(d), 0.0f, 1 );
}
...
float       polarAngleDistance( const D3DXVECTOR3& aVec1, const D3DXVECTOR3& aVec2 )
{
  D3DXVECTOR3 v1 = aVec1;
  D3DXVECTOR3 v2 = aVec2;
  v1.y = 0.0f;
  v2.y = 0.0f;
  return angleBetweenVectors(v1,v2);

  //float absPolarDelta = fabs( polarTangent - polarAB );
}
